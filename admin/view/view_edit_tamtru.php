<div class="panel panel-primary">
	...
	<div class="panel-body">
		<form action="index.php?controller=kb_tamtru&action=do_edit" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-2">Công an phường</div>
				<div class="col-md-10">
					<input type="text" placeholder="Công an phường" required class="form-control" name="conganphuong" value="<?php echo $data['conganphuong']; ?>">
				</div>
			</div><br>
			<div class="row">
